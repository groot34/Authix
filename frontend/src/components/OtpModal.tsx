...
export function OtpModal({ email, open, onClose, onSuccess, onToast }: OtpModalProps) {
  ...
  async function submitCode() {
    ...
    try {
      ...
      const message = error instanceof ApiError ? error.message : 'The code could not be verified.';
      setMessage(message);
